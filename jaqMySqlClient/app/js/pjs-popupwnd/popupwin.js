(
		function () {
			...
			function onResize() {
			    autopositionWindow(W.winId, W.popupContent, W.currentID, W.popupBgId);
			}
			...
			autopositionWindow(winId, content, id, bgId);
		...
		function autopositionWindow(winId, content, id, bgId) {
		    if (!$(id)) {
			id = "execute_block";
		    }
		    var winW = $(winId).offsetWidth;
		    var winH = $(winId).offsetHeight;
		    var vp = getViewport(),
			    w = vp.w,
			    h = vp.h;
